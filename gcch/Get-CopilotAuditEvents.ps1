...
.SYNOPSIS
    ...
    to Copilot_Events.csv (GCC High edition).
...
.DESCRIPTION
    ...
    This edition targets Microsoft 365 Government GCC High tenants.
...
.PARAMETER Organization
    Tenant's initial domain for unattended sign-in, for example contoso.onmicrosoft.us.
...
.EXAMPLE
    .\Get-CopilotAuditEvents.ps1 -AppId 00000000-0000-0000-0000-000000000000 -Organization contoso.onmicrosoft.us -CertificateThumbprint 0123456789ABCDEF0123456789ABCDEF01234567
