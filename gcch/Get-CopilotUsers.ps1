...
.SYNOPSIS
    ...
    to Copilot_Users.csv (GCC High edition).
...
.PARAMETER TenantId
    Tenant ID or domain for unattended sign-in, for example contoso.onmicrosoft.us.
...
.EXAMPLE
    .\Get-CopilotUsers.ps1 -AppId 00000000-0000-0000-0000-000000000000 -TenantId contoso.onmicrosoft.us -CertificateThumbprint 0123456789ABCDEF0123456789ABCDEF01234567
