...
.SYNOPSIS
    ...
    to Copilot_Users.csv ({{CLOUD_NAME}} edition).
...
.PARAMETER TenantId
    Tenant ID or domain for unattended sign-in, for example {{ORGANIZATION_EXAMPLE}}.
...
.EXAMPLE
    .\Get-CopilotUsers.ps1 -AppId 00000000-0000-0000-0000-000000000000 -TenantId {{ORGANIZATION_EXAMPLE}} -CertificateThumbprint 0123456789ABCDEF0123456789ABCDEF01234567
