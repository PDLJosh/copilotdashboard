...
.SYNOPSIS
    ...
    to Copilot_Events.csv ({{CLOUD_NAME}} edition).
...
.DESCRIPTION
    ...
    This edition targets {{CLOUD_DESCRIPTION}}.
...
.PARAMETER Organization
    Tenant's initial domain for unattended sign-in, for example {{ORGANIZATION_EXAMPLE}}.
...
.EXAMPLE
    .\Get-CopilotAuditEvents.ps1 -AppId 00000000-0000-0000-0000-000000000000 -Organization {{ORGANIZATION_EXAMPLE}} -CertificateThumbprint 0123456789ABCDEF0123456789ABCDEF01234567
